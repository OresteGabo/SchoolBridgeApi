...
class School {
    ...
    @ManyToMany
    @JoinTable(name = "schools_school_levels",
            joinColumns = @JoinColumn(name = "school_id"),
            inverseJoinColumns = @JoinColumn(name = "school_level_id"))
    private Set<SchoolLevel> schoolLevels = new HashSet<>();
}
